...
import com.alibaba.cloud.dubbo.util.ConverterUtils;
...
public class StandardRestService implements RestService {
	...
	public User requestBodyMap(Map<String, Object> data,
		...
		User user = new User();
		user.setId(ConverterUtils.toLong(data.get("id")));
		user.setName(ConverterUtils.toString(data.get("name")));
		user.setAge(ConverterUtils.toInteger(data.get("age")));
